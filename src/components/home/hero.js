        ...
        <div class="hero-content w-full px-6 sm:px-10 lg:px-20 max-w-screen-xl mx-auto">
            <div class="max-w-xl">
                ...
                <div class="flex flex-wrap gap-4 animate-fade-up delay-4">
                    <a href="#productSection" class="btn-primary">Beli Sekarang <svg class="w-4 h-4" fill="none"
                ...
                <div class="flex items-center gap-6 mt-12 animate-fade-up delay-5">
                    <div>
                        <p class="text-[#f5f0e8] font-semibold text-xl" style="font-family:'Playfair Display',serif">
                            500+</p>
